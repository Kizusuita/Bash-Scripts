...
read -a array <<< "$clean_word" #Split the string into an array, -a is naming it, declaring the array's name in as "array" bc it's -a array, the read is reading in from "<<< "$1"".
